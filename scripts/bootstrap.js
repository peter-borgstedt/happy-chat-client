...
const getBaseUrl = () => {
  ...
  if (html.dataset.environment === 'prod') {
    return {
      ...
      webServerUrl: 'https://d31k87hzkjbg8d.cloudfront.net/happychat/rest',
      webSocketUrl: 'wss://d31k87hzkjbg8d.cloudfront.net/happychat/ws',
    };
  }
  return {
    webServerUrl: 'https://d31k87hzkjbg8d.cloudfront.net/happychat/rest',
    ...
    //webServerUrl: 'http://localhost:8080/happychat/rest',
    //webSocketUrl: 'ws://localhost:8080/happychat/ws',
  };
};
